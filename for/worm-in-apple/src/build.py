...
if __name__ == '__main__':
    ...
    host_str = rot("worm-in-apple.ctf.insecurity-insa.fr")
    port_str = '*'.join([str(e) for e in prime_factors(443)])

    p("parameters:")
    p("\t'{}' -> '{}'".format("worm-in-apple.ctf.insecurity-insa.fr", host_str))
    p("\t{} -> {}".format(443, port_str))
